...
public class TmTravelServiceImpl implements ITmTravelService {
    ...
    public List<TmTravelDto> getTmTravels() throws SQLException{
        ...
        while (resultSet.next()) {
            ...
            TmTravelDto tmTravel = new TmTravelDto(id_tmodality_travel, tmodality.getTransportModalityName(), travel_description, cost_travel,
    ...
    public TmTravelDto getTmTravelById(int tmTravelId) throws SQLException{
        ...
        while (resultSet.next()) {
            ...
            tmTravel = new TmTravelDto(tmTravelId, tmodality.getTransportModalityName(), travel_description, cost_travel,
            		cost_travel_go_and_back, id_tmodality);
        }
        }
        return tmTravel;
